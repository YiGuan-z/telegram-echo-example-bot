...
open class MapApplicationConfig : ApplicationConfig {
    ...
    override fun toMap(): Map<String, Any?> {
        val keys =
            map.keys.filter { it.startsWith(path) }
        ...
        return keys.associate { key ->
            ...
            when {
                ...
                map.containsKey(combine(path, "size")) ->
                    when {
